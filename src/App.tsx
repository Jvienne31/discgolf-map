...
// Helper to get all saved courses from localStorage
...
const App = () => {
  ...
  // State to hold the active course ID, initialized from localStorage
  ...
  // Update the active course ID and save it to localStorage
  ...
  const handleExit = () => {
    ...
    setCourses(getSavedCourses()); // Refresh course list on exit
  };
